...
const clickHandler = (self) => {
    if ( 'function' === typeof self.options.bounds ) {
        self._map.fitBounds(self.options.bounds());
    }
...
//			this._link.title = i18n.fit_markers_in_view;
        ...
        L.DomEvent
            ...
            .on( this._link, 'click', e => clickHandler(this) )
    ...
    onRemove:function() {
        L.DomEvent
            ...
            .off(this._link, 'click', clickHandler, this )
